            ...
            return (
              ...
              >
                ...
                <div className="relative h-60 w-full bg-slate-900 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full border border-white/20 text-[10px] font-bold text-white uppercase tracking-wider">
