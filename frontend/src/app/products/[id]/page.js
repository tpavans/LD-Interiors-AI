...
import { Loader2, ArrowLeft, Calendar, Tag, ChevronRight, ChevronLeft, AlertCircle, Phone, ShoppingBag, X, MessageCircle, Check, Share2, Copy, Play, Sparkles, CheckCircle2 } from 'lucide-react';
          ...
          <div className="mt-10 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                {t?.orderBtn || (isTelugu ? "ఆర్డర్ వివరాలు" : "Order / Customize")}
              </button>
            </div>
          ...
          <div className="w-full max-w-md bg-wood-cream border-2 border-wood-accent/30 rounded-3xl p-6 shadow-2xl relative overflow-y-auto max-h-[85vh] text-left" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleOrderSubmit} className="space-y-4">
              ...
              <div className="rounded-xl bg-amber-50 border border-amber-200 p-3 text-[10px] text-amber-800 leading-relaxed font-medium">
                ⚠️ {t?.disclaimer || "For the latest pricing, material selection, and final quotation, please speak with Mr. Nagaraju (+916281653998). Once the quotation is confirmed, we'll proceed with your order."}
              </div>
