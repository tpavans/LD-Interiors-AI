  ...
  return (
    <div className="fixed bottom-26 right-6 z-[90] flex flex-col gap-3.5">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20ba5a] transition-all duration-300 hover:scale-110 active:scale-95 border border-[#20ba5a]/10 cursor-pointer"
      >
